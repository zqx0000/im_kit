...
public class ReceiveMessageView extends MessageView {
    public ReceiveMessageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.view_receive_message, this);
        initView();
    }
    @Override
