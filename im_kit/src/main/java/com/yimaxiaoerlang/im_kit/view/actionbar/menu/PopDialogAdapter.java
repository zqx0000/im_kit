package com.yimaxiaoerlang.im_kit.view.actionbar.menu;
...
import com.yimaxiaoerlang.im_kit.utils.BackgroundTasks;
...
public class PopDialogAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(YMIMKit.getAppContext()).inflate(R.layout.pop_dialog_adapter, parent, false);
